...
for n in random_states:
    ...
    # Create the model
    model = RandomForestClassifier(n_estimators=100, random_state=n, class_weight={0: 1, 1: 1.5}, verbose=True)
...
with open("./results/json/rf_30_results.json", "w") as json_file:
...
plt.xlabel('Métrica')
plt.ylabel('Valor')
plt.title('Métricas en los resultados de test de RF con 30 splits distintos')

plt.savefig("./results/plots/rf_boxplot_30.png") 
