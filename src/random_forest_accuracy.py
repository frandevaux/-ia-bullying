...
df= df[['Bullied_on_school_property_in_past_12_months',  'Physically_attacked', 'Other_students_kind_and_helpful', 'Most_of_the_time_or_always_felt_lonely', 'Missed_classes_or_school_without_permission', ]]
