...
train_sizes, train_scores, validation_scores = learning_curve(estimator = RandomForestClassifier(n_estimators=100, random_state=0, class_weight={0: 1, 1: 1.5}), X = x, y = y, scoring = 'neg_mean_squared_error', train_sizes = [1, 10, 100, 500, 1000, 5000, 10000, 15000, 20000, 25000, 30000, 35000, 40888], cv = 5)
...
plt.title('Curvas de Aprendizaje Random Forest v2', fontsize = 18, y = 1.03)
plt.legend()
plt.ylim(0,1)
plt.savefig('./results/plots/rf_learning_curve_error_v2.png')
